export const features = [
  {
    ...
    details: [
      'Orchard & Vineyard Drip Systems',
      'Solid Set Sprinklers',
      'Frost Protection integration',
      'Soil Moisture Monitoring',
      'System Audits & Retrofits',
      'GPS Mapping & Layout Design'
    ],
    imageKey: 'irrigation'
  },
  {
    title: 'Pump Stations',
    slug: 'pump-stations',
    description: 'Complete conceptual design and construction of pump stations and filtration hubs, ensuring robust and reliable water delivery.',
    longDescription: 'The heart of any water system is the pump station. We specialize in building robust, industrial-grade pump sheds and filtration hubs that guarantee consistent pressure and flow. Our turnkey solutions cover everything from the concrete pad to the final commisioning.',
    details: [
      'Multi-stage Centrifugal & Submersible Pumps',
      'Variable Speed Drives (VSD) for energy efficiency',
      'Media, Screen, & Disc Filtration',
      'Backflush Automation',
      'Pipe Manifolding & Fabrication',
  ...
  },
  {
    ...
    details: [
      ...
      'Bulk Tank Storage & Mixing Sytems',
      'Safety Interlocks & Backflow Prevention',
      'Automated Batching Strategies'
    ],
    imageKey: 'fertigation'
  },
  {
